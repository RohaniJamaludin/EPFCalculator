...
public class SipAdd implements ActionListener{
	...
	private void initialize() {
		SipMain.footerPanel.getComponent(0).setEnabled(false); 
	
		dialog = new JDialog(SipMain.frame,"Add Sip Contribution Rate", true);
		dialog.addWindowListener(new WindowAdapter() {
			public void  windowClosed(WindowEvent event) {
				System.out.println("Closed");
				SipMain.footerPanel.getComponent(0).setEnabled(true);
			}
		});
